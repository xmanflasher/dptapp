...
class LiveHUD extends StatelessWidget {
  ...
  Widget _buildMainMetric(String label, String value, String unit, Color color) {
    return Column(
      children: [
        Text(label, style: TextStyle(color: color.withValues(alpha: 0.7), fontSize: 16, fontWeight: FontWeight.bold)),
        Row(
          ...
          children: [
            ...
            Text(unit, style: TextStyle(color: color.withValues(alpha: 0.7), fontSize: 20)),
          ],
        ),
      ],
    );
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(unit, style: TextStyle(color: color.withValues(alpha: 0.7), fontSize: 12)),
          ],
        ),
      ],
    );
